...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'apartamentos.apartamentosbundle.manager.color' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Apartamentos\ApartamentosBundle\Manager\ColorManager A Apartamentos\ApartamentosBundle\Manager\ColorManager instance.
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'appcore', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the 'globalfunctions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Apartamentos\ApartamentosBundle\Controller\GlobalfunctionsController A Apartamentos\ApartamentosBundle\Controller\GlobalfunctionsController instance.
     */
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'LexikTranslationBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
