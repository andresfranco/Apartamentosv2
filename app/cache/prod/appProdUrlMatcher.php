    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/multiparam')) {
                ...
                // multiparam_create
                if (preg_match('#^/admin/multiparam/(?P<_locale>[^/]++)/new$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                ...
                // multiparam_edit
                if (preg_match('#^/admin/multiparam/(?P<_locale>[^/]++)/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                // multiparamgrid
                if (preg_match('#^/admin/multiparam/(?P<_locale>[^/]++)/(?P<sysparamid>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                if (preg_match('#^/admin/multiparam/(?P<_locale>[^/]++)/delemultiparam/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
