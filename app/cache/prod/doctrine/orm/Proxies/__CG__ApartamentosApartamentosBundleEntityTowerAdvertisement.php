 ...
 */
class TowerAdvertisement extends \Apartamentos\ApartamentosBundle\Entity\TowerAdvertisement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'advertisementid', 'towerid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TowerAdvertisement $proxy) {
    ...
    public function setAdvertisementid(\Apartamentos\ApartamentosBundle\Entity\Advertisement $advertisementid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdvertisementid', array($advertisementid));

        return parent::setAdvertisementid($advertisementid);
    }
    ...
    public function getAdvertisementid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdvertisementid', array());

        return parent::getAdvertisementid();
    }
