 ...
 */
class Color extends \Apartamentos\ApartamentosBundle\Entity\Color implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'color', 'translations', 'locale', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
