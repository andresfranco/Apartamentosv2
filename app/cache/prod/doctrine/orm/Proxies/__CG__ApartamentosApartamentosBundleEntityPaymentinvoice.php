 ...
 */
class Paymentinvoice extends \Apartamentos\ApartamentosBundle\Entity\Paymentinvoice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'description', 'paymentid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Paymentinvoice $proxy) {
