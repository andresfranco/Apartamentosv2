 ...
 */
class Sysparam extends \Login\LoginBundle\Entity\Sysparam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'value', 'description', 'createuser', 'modifyuser', 'createdate', 'modifydate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sysparam $proxy) {
