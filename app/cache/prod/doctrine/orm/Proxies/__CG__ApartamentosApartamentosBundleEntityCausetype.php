 ...
 */
class Causetype extends \Apartamentos\ApartamentosBundle\Entity\Causetype implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'causetype', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Causetype $proxy) {
    ...
    public function setCausetype($causetype)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCausetype', array($causetype));

        return parent::setCausetype($causetype);
    }
    ...
    public function getCausetype()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCausetype', array());

        return parent::getCausetype();
    }
