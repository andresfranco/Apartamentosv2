 ...
 */
class Roleaction extends \Login\LoginBundle\Entity\Roleaction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'createuser', 'modifyuser', 'createdate', 'modifydate', 'actionid', 'roleid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Roleaction $proxy) {
    ...
    public function setActionid(\Login\LoginBundle\Entity\Action $actionid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActionid', array($actionid));
    ...
    public function getActionid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActionid', array());
