 ...
 */
class Parking extends \Apartamentos\ApartamentosBundle\Entity\Parking implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'number', 'type', 'apartmentid', 'locationid', 'companyid', 'towerid', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
