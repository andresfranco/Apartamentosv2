 ...
 */
class Expense extends \Apartamentos\ApartamentosBundle\Entity\Expense implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'expensedate', 'amount', 'paymentmethod', 'description', 'accountid', 'causeid', 'towerid', 'companyid', 'providerid', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
    ...
    public function setExpensedate($expensedate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExpensedate', array($expensedate));
    ...
    public function getExpensedate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExpensedate', array());
