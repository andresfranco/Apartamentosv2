 ...
 */
class Brand extends \Apartamentos\ApartamentosBundle\Entity\Brand implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'brand', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
