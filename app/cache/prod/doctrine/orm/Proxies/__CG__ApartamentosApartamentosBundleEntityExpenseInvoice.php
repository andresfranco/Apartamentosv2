 ...
 */
class ExpenseInvoice extends \Apartamentos\ApartamentosBundle\Entity\ExpenseInvoice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'description', 'name', 'path', 'expenseid', 'file', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExpenseInvoice $proxy) {
    ...
    public function setExpenseid(\Apartamentos\ApartamentosBundle\Entity\Expense $expenseid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExpenseid', array($expenseid));

        return parent::setExpenseid($expenseid);
    }
    ...
    public function getExpenseid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getExpenseid', array());

        return parent::getExpenseid();
    }
