 ...
 */
class Bank extends \Apartamentos\ApartamentosBundle\Entity\Bank implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'address', 'phone', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
