 ...
 */
class Residenttype extends \Apartamentos\ApartamentosBundle\Entity\Residenttype implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Residenttype $proxy) {
