 ...
 */
class Location extends \Apartamentos\ApartamentosBundle\Entity\Location implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'location', 'description', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
