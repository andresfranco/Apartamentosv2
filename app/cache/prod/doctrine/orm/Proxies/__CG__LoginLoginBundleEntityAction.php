 ...
 */
class Action extends \Login\LoginBundle\Entity\Action implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'actionname', 'description', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
