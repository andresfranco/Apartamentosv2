 ...
 */
class Multiparam extends \Login\LoginBundle\Entity\Multiparam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'value', 'description', 'createuser', 'modifyuser', 'createdate', 'modifydate', 'sysparamid');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Multiparam $proxy) {
    ...
    public function setSysparamid(\Login\LoginBundle\Entity\Sysparam $sysparamid = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSysparamid', array($sysparamid));

        return parent::setSysparamid($sysparamid);
    }
    ...
    public function getSysparamid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSysparamid', array());

        return parent::getSysparamid();
    }
