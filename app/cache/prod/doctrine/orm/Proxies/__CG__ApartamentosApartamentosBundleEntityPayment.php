 ...
 */
class Payment extends \Apartamentos\ApartamentosBundle\Entity\Payment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'paymentdate', 'amount', 'depositor', 'description', 'paymentmethod', 'accountid', 'apartmentid', 'companyid', 'towerid', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
