 ...
 */
class Role extends \Login\LoginBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
