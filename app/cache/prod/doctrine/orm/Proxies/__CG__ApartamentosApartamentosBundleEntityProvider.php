 ...
 */
class Provider extends \Apartamentos\ApartamentosBundle\Entity\Provider implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'phone', 'email', 'address', 'companyid', 'towerid', 'createdate', 'createuser', 'modifydate', 'modifyuser');
        }
