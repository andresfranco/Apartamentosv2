...
namespace Proxies\__CG__\Apartamentos\ApartamentosBundle\Entity\Translation;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ColorTranslation extends \Apartamentos\ApartamentosBundle\Entity\Translation\ColorTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ColorTranslation $proxy) {
