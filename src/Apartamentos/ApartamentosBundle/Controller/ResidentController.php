...
use Apartamentos\ApartamentosBundle\Entity\Resident;
use Apartamentos\ApartamentosBundle\Form\ResidentType;
...
class ResidentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApartamentosApartamentosBundle:Resident')->findAll();
     ...
     *
     * @Route("/{_locale}/new", name="resident_create")
     * @Method("POST")
     * @Template("ApartamentosApartamentosBundle:Resident:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('residents_show', array('id' => $entity->getId())));
        }
    ...
    */
     ...
     *
     * @Route("/{_locale}/new", name="residents_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{_locale}/{id}", name="residents_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApartamentosApartamentosBundle:Resident')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Resident entity.');
        }

        $delete = $this->get('globalfunctions')->verifyaction("Delete Resident");
     ...
     *
     * @Route("/{_locale}/{id}/edit", name="residents_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{_locale}/{id}/edit", name="resident_update")
     * @Method("PUT")
     * @Template("ApartamentosApartamentosBundle:Resident:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('residentsgrid', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('residentsgrid'));
    }
    ...
    private function createDeleteForm($id)
    {
     ...
     /**
     * Grid Resident
     *@Route("/{_locale}/residentlist/", name="residentsgrid")
     */
    public function ResidentgridAction()
    {
       ...
       $grid->hideColumns(array('id','idnumbertype','holder','email','phone','createdate','createuser','modifyuser','modifydate'));
       //$grid->
        return $grid->getGridResponse('ApartamentosApartamentosBundle:Resident:residentgrid.html.twig',array('create'=>$create,'edit'=>$edit,'urlnew'=>'residents_new'));
    }
    /**
     * Deletes a Resident entity.
     *@Route("/{_locale}/deleteresident/{id}", name="resident_deletemodal")
     */
      ...
      if (!$entity) 
       {
        throw $this->createNotFoundException('Unable to find Resident entity.');
            ...
            {
            $this->get('session')->getFlashBag()->add('error', 'delete.resident.dbaexception');
    ...
    /**
     * 
     *@Route("/residenttower", name="resident_select_tower")
     */
...
public function TowersAction(Request $request)
{
    ...
    /**
     * 
     *@Route("/residentapt", name="resident_select_apartment")
     */
