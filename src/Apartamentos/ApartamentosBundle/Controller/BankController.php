...
class BankController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ApartamentosApartamentosBundle:Bank')->findAll();
     ...
     *
     * @Route("/{_locale}/new", name="bank_create")
     * @Method("POST")
     * @Template("ApartamentosApartamentosBundle:Bank:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('bank_show', array('id' => $entity->getId())));
        }
    ...
    */
     ...
     *
     * @Route("/{_locale}/new", name="bank_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{_locale}/{id}", name="bank_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ApartamentosApartamentosBundle:Bank')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Bank entity.');
        }

       $delete =$actions= $this->get('globalfunctions')->verifyaction("Delete Bank");
     ...
     *
     * @Route("/{_locale}/{id}/edit", name="bank_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{_locale}/{id}", name="bank_update")
     * @Method("PUT")
     * @Template("ApartamentosApartamentosBundle:Bank:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('bankgrid'));
        }
     ...
     *
     * @Route("/{_locale}/{id}", name="bank_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
      ...
      /**
     * Grid Location
     *@Route("/{_locale}/banklist/", name="bankgrid")
     */
    public function BankgridAction()
    {
        
        // Creates a simple grid based on your entity (ORM)
        $source = new Entity('ApartamentosApartamentosBundle:Bank');
        ...
        $create= $this->get('globalfunctions')->verifyaction("Create Bank");
        $edit = $this->get('globalfunctions')->verifyaction("Edit Bank");
        ...
        // Attach a rowAction to the Actions Column
         $editAction = new RowAction('Edit', 'bank_edit',false, '_self', array('class' => 'editar'));
        ...
        // Attach a rowAction to the Actions Column
         ...
         $showAction = new RowAction('Show', 'bank_show',false, '_self', array('class' => 'mostrar'));
        ...
        return $grid->getGridResponse('ApartamentosApartamentosBundle:Bank:bankgrid.html.twig',array('create'=>$create,'urlnew'=>'bank_new'));
    }
    /**
     * Deletes a Bank entity.
     *@Route("/{_locale}/deletebank/{id}", name="bank_deletemodal")
     */
      ...
      if (!$entity) 
       {
        throw $this->createNotFoundException('Unable to find Bank entity.');
            ...
            {
            $this->get('session')->getFlashBag()->add('error', 'delete.bank.dbaexception');
